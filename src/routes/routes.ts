...
const models: TsoaRoute.Models = {
  ...
  ContactNumberResponseDto: {
    ...
    type: {
      dataType: 'nestedObjectLiteral',
      nestedProperties: {
        status: { ref: 'ResposeStatusDto', required: true },
  ...
  ResponseUserDto: {
    ...
    type: {
      ...
      nestedProperties: {
        ...
        status: { ref: 'ResposeStatusDto', required: true },
        address: { ref: 'ResponseAddressDto', required: true },
        contactNumber: { ref: 'ContactNumberResponseDto', required: true },
...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    ...
    async function UserController_list(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
  ...
  app.get(
    ...
    async function UserController_getById(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsUserController_getById,
          request,
          response,
        });
  ...
  app.post(
    ...
    async function UserController_create(
      request: ExRequest,
      response: ExResponse,
      next: any,
    ) {
      ...
      try {
        validatedArgs = templateService.getValidatedArgs({
          args: argsUserController_create,
          request,
          response,
        });
